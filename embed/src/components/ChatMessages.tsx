                ...
                >
                  {i === 0 && (
                    <div className="cbw-msg-sender">
                      {profilePicture && (
                        <img src={profilePicture} alt="" className="cbw-msg-avatar" />
                      )}
              ...
              return (
                ...
                >
                  <div
                    ...
                    style={
                      isUser ? { backgroundColor: brandColor, color: contrastColor } : undefined
                    }
                  >
                    ...
                    {isStreaming && !chat.content && (
                      <div className={`cbw-typing ${isDark ? 'cbw-typing--dark' : ''}`}>
                        <span className="cbw-dot" style={{ animationDelay: '0s' }} />
                        <span className="cbw-dot" style={{ animationDelay: '0.15s' }} />
                        <span className="cbw-dot" style={{ animationDelay: '0.3s' }} />
                      </div>
                    )}
                  ...
                  {!isUser && !isStreaming && chat.id && (
                    <div className="cbw-msg-actions">
                      ...
                      >
                        <svg width="12" height="12" viewBox="0 0 24 24" fill={chat.feedback === 'like' ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      ...
                      >
                        <svg width="12" height="12" viewBox="0 0 24 24" fill={chat.feedback === 'dislike' ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="cbw-suggestions">
            {suggestedMessages.map((s, i) => (
              <button
                ...
                style={{ '--cbw-hover-bg': brandColor, '--cbw-hover-text': contrastColor } as any}
