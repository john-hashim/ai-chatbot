...
export const bookingsService = {
  ...
  getAvailability: (
    ...
    return apiClient.get(ENDPOINTS.BOOKINGS.GET_AVAILABILITY.replace(':chatbotId', chatbotId))
  },
  ...
  updateTimeSlots: (
    ...
    return apiClient.patch(
      ENDPOINTS.BOOKINGS.UPDATE_TIMESLOTS.replace(':chatbotId', chatbotId).replace(
        ':slotId',
        slotId
      ),
      data
  ...
  deleteSlot: (chatbotId: string, slotId: string): Promise<AxiosResponse<ApiResponse>> => {
  ...
  getBookingConfig: (
    ...
    return apiClient.get(ENDPOINTS.BOOKINGS.GET_CONFIG.replace(':chatbotId', chatbotId))
  },
  ...
  updateBookingConfig: (
    ...
    return apiClient.patch(ENDPOINTS.BOOKINGS.UPDATE_CONFIG.replace(':chatbotId', chatbotId), data)
  },
  ...
  getTimeSlotsForDate: (
    ...
    return apiClient.post(ENDPOINTS.BOOKINGS.GET_TIMESLOTS.replace(':chatbotId', chatbotId), data)
  },
